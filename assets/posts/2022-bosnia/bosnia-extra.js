...
async function addPlaces2(map, places, className, ttClassName, doAddLines) {
    ...
    for (let place of places) {
        ...
        circle.bindTooltip(name, {
            ...
            className: ttClassName + " sans-serif f6 f5-l" + (active ? " mapPlaceActive" : ""),
            permanent: true,
            direction: direction,
...
async function main2() {
    await loadBoundaries2(['Bosnia and Herzegovina', 'Serbia', 'Croatia', 'Montenegro', 'Kosovo']);
    ...
    let contextBoundary = await renderOverlay2(mapNeighbors, 'Bosnia and Herzegovina', "mapOutlineNeighbor", "#357EDD");
    let croatiaBoundary = await renderOverlay2(mapNeighbors, 'Croatia', "mapOutlineNeighbor", "#FFD700");
    let serbiaBoundary = await renderOverlay2(mapNeighbors, 'Serbia', "mapOutlineNeighbor", "#E7040F");
    let kosovoBoundary = await renderOverlay2(mapNeighbors, 'Kosovo', "mapOutlineNeighbor", "#FF725C");
    let montenegroBoundary = await renderOverlay2(mapNeighbors, 'Montenegro', "mapOutlineNeighbor", "#FF725C");
    ...
    let tripOverlay = await renderOverlay2(mapHerzegovina, 'Bosnia and Herzegovina', "mapOutlineTravel", "#357EDD", 0.2);
