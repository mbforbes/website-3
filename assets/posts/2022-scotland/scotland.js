...
async function main() {
    ...
    const places = [
        [55.9530, -3.1890, "Edinburgh", "right", "in"],
        [57.1500, -2.1100, "Aberdeen", "right", "out"],
        [57.4778, -4.2247, "Inverness", "top", "out"],
        [57.275270, -6.042294, "Isle of Skye", "left", "in"],
        [56.4120, -5.4720, "Oban", "right", "in"],
        [55.8611, -4.2500, "Glasgow", "left", "n/a"],
    ];
