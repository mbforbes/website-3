...
- Extra lessons re, e.g., patterns about intransitive vs transitive
  ...
  - Also, in reviews, bring up both. Often one several lessons far away from the other, so you don't get practice, because it's just the more recent one every time. (e.g., 交ぜる and 交じる)
...
- Also, sometimes straight up doesn't teach one at all, then says you know it
  - e.g., 科目 uses もく for 目, but that was only learned in a previous vocab (目次). this kind of thing works OK if it's always kunyomi, but if you just learn it as an exception, it's frustrating when it's like oh yeah you should know that one
...
- does not offer any mnemonic help or even acknowledgement of two kanji with same radical composition: 申 and 由
